...
exp_aux =  (* Expressions *)
 ...
 | Aspect of terminal * x * exp * terminal (* Aspects *)
 | Aspect_with_fallback of terminal * x * exp * terminal * exp * terminal (* Aspects with alternative if the aspect is excluded *)
